...
public class DataTypePersistenceImpl
	 ...
	 */
	@Override
	public List<DataType> findByNameVersion(
	...
	public List<DataType> findByNameVersion(
		...
		return findByNameVersion(
			dataTypeName, dataTypeVersion, start, end, null);
	}
	...
	public DataType findByNameVersion_First(
		...
		DataType dataType = fetchByNameVersion_First(
	...
	public DataType fetchByNameVersion_First(
		...
		List<DataType> list = findByNameVersion(
	...
	public DataType findByNameVersion_Last(
		...
		DataType dataType = fetchByNameVersion_Last(
			dataTypeName, dataTypeVersion, orderByComparator);
	...
	public DataType fetchByNameVersion_Last(
		...
		int count = countByNameVersion(dataTypeName, dataTypeVersion);
	...
	public DataType[] findByNameVersion_PrevAndNext(
		...
		try {
			...
			array[0] = getByNameVersion_PrevAndNext(
				session, dataType, dataTypeName, dataTypeVersion,
	...
	protected DataType getByNameVersion_PrevAndNext(
		Session session, DataType dataType, String dataTypeName,
