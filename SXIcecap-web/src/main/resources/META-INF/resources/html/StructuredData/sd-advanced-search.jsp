						...
						<div style="display:inline-block; width:40%;">
							<aui:fieldset label="operator-between-fields">
								<div style="display:inline-block; width:20%;">
									<aui:input type="radio" name="operatorBetweenFields"  value="or" label="Or" checked="true"></aui:input>
								</div>
								<div style="display:inline-block; width:20%;">
									<aui:input type="radio" name="operatorBetweenFields"  value="and" label="And"></aui:input>
								</div>
							</aui:fieldset>
						</div>
						<div style="display:inline-block; width:40%;">
							<aui:fieldset label="operator-in-field">
								<div style="display:inline-block; width:20%;">
									<aui:input type="radio" name="operatorInField"  value="or" label="Or" checked="true"></aui:input>
								</div>
								<div style="display:inline-block; width:20%;">
									<aui:input type="radio" name="operatorInField"  value="and" label="And"></aui:input>
								</div>
							</aui:fieldset>
						</div>
					</aui:fieldset-group>
...
$(document).ready(function(){
	...
	$('input[name="<portlet:namespace/>operatorBetweenFields"]').change(function(event){
		dataStructure.fieldOperator = $(this).val();
	});
	
	$('input[name="<portlet:namespace/>operatorInField"]').change(function(event){
